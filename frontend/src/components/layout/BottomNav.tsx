...
export default function BottomNav() {
    ...
    return (
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-50 px-3 pb-3">
            <div className="pointer-events-auto mx-auto max-w-xl rounded-[28px] border border-white/70 bg-white/92 px-2 py-2 shadow-[0_18px_50px_rgba(15,23,42,0.16)] backdrop-blur-xl">
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {isActive && <span className="absolute top-1 h-1 w-1 rounded-full bg-[#155aa6]" />}
                            </Link>
                        );
                    })}
                </div>
