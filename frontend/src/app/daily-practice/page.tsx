            ...
            <main className="mx-auto flex w-full max-w-4xl flex-col gap-5 px-4 py-4">
                <section className="overflow-hidden rounded-[32px] border border-slate-900 bg-slate-950 text-white shadow-[0_24px_70px_rgba(15,23,42,0.22)]">
                    <div className="relative p-5">
                        ...
                        <div className="absolute -left-16 bottom-0 h-44 w-44 rounded-full bg-rose-400/25 blur-3xl" />
                        <div className="absolute -right-16 -top-10 h-44 w-44 rounded-full bg-amber-300/25 blur-3xl" />
                        <div className="relative">
                            <div className="flex items-start justify-between gap-4">
                                <div>
                                    <p className="text-xs font-black text-amber-100">آموزش روزانه</p>
                                    <h1 className="mt-2 text-3xl font-black tracking-tight">زنجیره یادگیری</h1>
                                    <p className="mt-3 max-w-[290px] text-sm leading-7 text-white/75">
                                        امروز {formatJalaliFull(todayJalali)} است. با دیدن ویدیو یا مرور لغات، روزت فعال می‌شود.
                                    </p>
                                </div>
                                <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-[24px] border border-white/15 bg-white/[0.12] shadow-inner">
                                    <Flame size={30} className="text-amber-200" />
                                </div>
                            </div>

                            <div className="mt-6 grid grid-cols-3 gap-3">
                                <HeroStat label="استریک فعلی" value={summary.streak.current_days} suffix="روز" />
                                <HeroStat label="دقیقه امروز" value={summary.today.minutes} suffix="دقیقه" />
                                <HeroStat label="لغات امروز" value={summary.today.learned_words_count} suffix="عدد" />
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <Surface className="p-5">
                    <div className="flex items-center justify-between gap-4">
                        <div>
                            <p className="text-xs font-black text-rose-500">هدف امروز</p>
                ...
                <Surface className="p-5">
                    <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="text-center">
                            <p className="text-xs font-black text-rose-500">تقویم شمسی فعالیت</p>
                ...
                <Surface className="p-5">
                    <div className="flex items-center justify-between gap-3">
                        <div>
                            <p className="text-xs font-black text-rose-500">نمودار هفتگی</p>
...
function HeroStat({ label, value, suffix }: { label: string; value: number; suffix: string }) {
    return (
        <div className="rounded-[22px] border border-white/15 bg-white/[0.10] px-3 py-3">
            <p className="text-[10px] font-bold text-white/[0.62]">{label}</p>
            <div className="mt-1 flex items-baseline gap-1">
                <span className="text-2xl font-black">{toPersianDigits(value)}</span>
                <span className="text-[10px] font-bold text-white/[0.65]">{suffix}</span>
            </div>
        </div>
    );
}
    ...
    return (
        <div className="relative flex h-20 w-20 shrink-0 items-center justify-center rounded-full bg-slate-100">
            <div
                ...
                style={{
                    background: `conic-gradient(#f43f5e ${clamped * 3.6}deg, #e2e8f0 0deg)`,
                }}
            />
            ...
            <div className="flex h-24 w-full items-end justify-center">
                <div
                    className={cn(
                        ...
                        warm ? "bg-gradient-to-t from-amber-500 to-orange-300" : "bg-gradient-to-t from-rose-500 to-pink-300",
                    )}
                    style={{ height }}
                />
            </div>
